  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.gridWrapper}>
        <GameGrid
          grid={grid}
          selectedBlock={selectedPiece !== null ? pieces[selectedPiece] : null}
          onPlace={place}
        />
      </View>
      ...
      <Text style={styles.hint}>
        {selectedPiece !== null ? t('tapGrid') : t('selectPiece')}
      </Text>
      ...
      <View style={styles.pieces}>
        {pieces.map((block, i) => (
          <BlockPiece
            ...
            onPress={() => selectPiece(i as 0 | 1 | 2)}
          />
        ))}
      </View>
      ...
      <Modal visible={isOver} transparent animationType="fade">
        <View style={styles.overlay}>
          <View style={styles.modal}>
            ...
            {score > 0 && score >= best && (
              <Text style={styles.newBest}>{t('best')}!</Text>
            )}
...
const styles = StyleSheet.create({
  ...
  hint: { color: TEXT_DIM, fontSize: 13, textAlign: 'center', paddingVertical: 6 },
  pieces: { flexDirection: 'row', justifyContent: 'space-around', paddingHorizontal: 8, paddingVertical: 4, backgroundColor: SURFACE, marginHorizontal: 12, borderRadius: 12, minHeight: 100 },
  controls: { paddingHorizontal: 16, paddingBottom: 8, paddingTop: 4 },
  btn: { backgroundColor: SURFACE, borderRadius: 10, paddingVertical: 10, alignItems: 'center' },
  ...
  newBest: { fontSize: 18, color: '#ffd700', fontWeight: '700' },
